...
export const JobInformation = ({
  ...
  return (
    ...
    >
      <motion.div
        layout
        className={`${isSelected ? "m-4 w-full max-w-2xl" : "w-full"}`}
        transition={{
      ...
      >
        ...
        >
          {!isSelected && (
            <div className="absolute bottom-0 left-0 top-0 w-1.5 bg-[#10B981]" />
          )}
            ...
            {isSelected && (
              ...
              >
                <Button
                  ...
                  className="mt-4 w-24 rounded-md bg-[#10B981] px-4 py-2 text-white transition-colors hover:bg-[#0D9668]"
                >
                  Close
                </Button>
              </motion.div>
