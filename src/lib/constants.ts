export const GALLERY_IMAGES = [
  ...
  export const 	PROJECT_DATA = [
		{name:'1UP', web:'https://oneup-pi.vercel.app/', image:'/1up.png', badge:[{name: 'Next.js 13'},{name: 'Typescript'}, {name: 'Zustand'}, {name: 'Mantine'}, {name: 'TanStack'}, {name: 'Supabase'}], github:'https://github.com/Cartel-1UP/1UP-website',  description:'Short description 1', fullDescription: 'Full description'},
    {name: 'Rick&Morty', web:'https://wiki-rickmorty.vercel.app/', image:'/rickmorty.png', badge:[{name: 'Next.js 14'}, {name: 'Typescript'}, {name: 'GraphQL'}, {name: 'TanStack'}, {name: 'Shadcn'}, {name: 'Tailwind'}], github: 'https://github.com/kicky1/rickmorty-wiki', description: 'Short description 2', fullDescription: 'Full description'},
    {name:'Interview Tasks', web:'https://interviewtasks.vercel.app/', image:'/interviewtasks.png', badge:[{name: 'Next.js 13'},{name: 'Typescript'}, {name: 'JavaScript'}, {name: 'Tailwind'}], github:'https://github.com/kicky1/interview',  description:'Short description 3', fullDescription: 'Full description'},
		{name: 'Bingo', web:'https://kith-bingo.vercel.app/', image:'/bingo.png', badge:[{name: 'Nextjs 14'},{name: 'Typescript'},{name: 'Shadcn'},{name: 'Clerk'}, {name: 'Drizzly'}, {name: 'Postgress'} ], github:'https://github.com/kicky1/bingo',  description:'Short description 4', fullDescription: 'Full description'},
    {name:'eTrener',image:'',  badge:[{name: 'Python'}, {name: 'OpenCV'}, {name: 'Tkinter'}, {name: 'Pandas'}, {name: 'Openpose'}], github:'https://github.com/kicky1/eTrener2', description:`Short description 5`, fullDescription: 'Full description'},
		{name:'Activity Recognition',image:'',  badge:[{name: 'Python'}, {name: 'React.js'}, {name: 'CNN'}, {name: 'MLP'}, {name: 'RBM'}, {name: 'Tensorflow'}, {name: 'Keras'}], github:'https://github.com/kicky1/ActivityRecognition', description:`Short description 6`, fullDescription: 'Full description'},
  ]